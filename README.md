...
Это веб-приложение для загрузки, анализа и визуализации данных о железнодорожной сети из OpenStreetMap. Проект вырос из простой консольной утилиты в полноценное веб-приложение на Flask с интерактивной картой.

(Замените ссылку на скриншот вашего работающего приложения)
